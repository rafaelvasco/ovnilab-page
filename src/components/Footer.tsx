...
const Footer = () => {
  ...
  return <footer className="pt-16 pb-8 px-6 md:px-12 lg:px-24 bg-ovnilab-darkPurple relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            <div className="mb-6">
              <a href="#" className="text-ovnilab-text font-space font-bold text-2xl inline-flex items-center">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 rounded-full bg-ovnilab-purple/20 flex items-center justify-center hover:bg-ovnilab-purple/40 transition-colors">
                <svg className="w-5 h-5 text-ovnilab-text" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
