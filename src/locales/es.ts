...
export const es: Translations = {
  ...
  instagramAgentDesc: 'Responde a comentarios de leads, elimina automáticamente contenido ofensivo y gestiona conversaciones por mensajes directos de manera profesional.',
