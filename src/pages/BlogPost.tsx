...
const BlogPost = () => {
  ...
  // Important: These settings need to be applied before parsing
  marked.use({
    gfm: true,
    breaks: true,
    headerIds: true,
